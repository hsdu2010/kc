...
/**
 * WebserviceManagerController类
 *
 * @author 01369626
*/
@RequestMapping("webserviceManager")
@Controller
public class WebserviceManagerController {

	@Autowired
    private WebserviceManagerService webserviceManagerService;
    ...
    */
	...
	public Integer countByExample(WebserviceManagerExample example){
		int count = 0;
	    count = webserviceManagerService.countByExample(example);
	    return count;
	}
    ...
    */
    ...
    public Boolean deleteByPrimaryKey(String id){
    	...
    	int count = 0;
    	count = webserviceManagerService.deleteByPrimaryKey(id);
        return  count > 0;
    }
    ...
    */
    ...
    @ResponseBody
    public Boolean insert(WebserviceManager record){
    	if(record == null){
			throw new IllegalStateException("参数record不能为空");
		}
    	int count = 0;
    	count = webserviceManagerService.insert(record);
        return  count > 0;
    }
    ...
    */	
    ...
    @ResponseBody
    public Map<String, Object> selectByExample(WebserviceManager record, Integer offset, Integer pageSize){
    	...
    	WebserviceManagerExample example = new WebserviceManagerExample(); 
    	Page<WebserviceManager> rows = null;
		rows = webserviceManagerService.selectByExample(example, pageNum, pageSize);
    ...
    */	
	...
	public WebserviceManager selectByPrimaryKey(String id){
	    ...
	    return webserviceManagerService.selectByPrimaryKey(id);
	}
    ...
    */
    ...
    @ResponseBody
	public Boolean updateByPrimaryKeySelective(WebserviceManager record){
		if(record == null){
			throw new IllegalStateException("参数record不能为空");
		}
	    ...
	    int count = 0;
		count = webserviceManagerService.updateByPrimaryKeySelective(record);
	    return count > 0; 
	}
	...
	public Map<String, Object> searchByName(String name, Integer offset, Integer pageSize){
		...
		Page<WebserviceManager> rows = null;
		rows = webserviceManagerService.searchByName(name, pageNum, pageSize);
		resultMap.put("rows", rows.getResult());
		resultMap.put("totalRecord", rows.getTotal());
		return resultMap;
	}
