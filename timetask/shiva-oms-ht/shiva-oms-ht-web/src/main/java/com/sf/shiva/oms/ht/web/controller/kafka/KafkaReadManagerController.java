...
/**
 * KafkaReadManagerController类
 *
 * @author 01369626
*/
@RequestMapping("kafkaReadManager")
@Controller
public class KafkaReadManagerController {

	@Autowired
    private KafkaReadManagerService kafkaReadManagerService;
    ...
    */
	...
	public Integer countByExample(KafkaReadManagerExample example){
		int count = 0;
	    count = kafkaReadManagerService.countByExample(example);
	    return count;
	}
    ...
    */
    ...
    public Boolean deleteByPrimaryKey(String id){
    	...
    	int count = 0;
    	count = kafkaReadManagerService.deleteByPrimaryKey(id);
        return  count > 0;
    }
    ...
    */
    ...
    @ResponseBody
    public Boolean insert(KafkaReadManager record){
    	if(record == null){
			throw new IllegalStateException("参数record不能为空");
		}
    	int count = 0;
    	count = kafkaReadManagerService.insert(record);
        return  count > 0;
    }
    ...
    */	
    ...
    @ResponseBody
    public Map<String, Object> selectByExample(KafkaReadManager record, Integer offset, Integer pageSize){
    	...
    	KafkaReadManagerExample example = new KafkaReadManagerExample(); 
    	Page<KafkaReadManager> rows = null;
		rows = kafkaReadManagerService.selectByExample(example, pageNum, pageSize);
    ...
    */	
	...
	public KafkaReadManager selectByPrimaryKey(String id){
	    ...
	    return kafkaReadManagerService.selectByPrimaryKey(id);
	}
    ...
    */
    ...
    @ResponseBody
	public Boolean updateByPrimaryKeySelective(KafkaReadManager record){
		if(record == null){
			throw new IllegalStateException("参数record不能为空");
		}
	    ...
	    int count = 0;
		count = kafkaReadManagerService.updateByPrimaryKeySelective(record);
	    return count > 0; 
	}
	...
	public Map<String, Object> searchByName(String name, Integer offset, Integer pageSize){
		...
		if(pageSize != null){
   		...
   		Page<KafkaReadManager> rows = kafkaReadManagerService.searchByName(name, pageNum, pageSize);
   		resultMap.put("rows", rows.getResult());
		resultMap.put("totalRecord", rows.getTotal());
        return resultMap;
	}
